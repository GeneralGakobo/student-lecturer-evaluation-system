            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					 ...
					 <li style="color:#FFFFFF">
                        <a style="color:#FFFFFF" class="active" href="index.php?info=home"><i class="fa fa-home fa-fw"></i>Home</a>
                    </li>
					
				
					<li><a style="color:#FFFFFF" href="index.php?info=registration"><i class="fa fa-sign-out fa-fw"></i>Registration</a></li>
	 <li>
                        <a style="color:#FFFFFF" href="index.php?info=faculty_login"><i class="fa fa-sign-in fa-fw"></i>Faculty</a>
                    </li>

                    <li>
                        <a style="color:#FFFFFF" href="index.php?info=login"><i class="fa fa-sign-in fa-fw"></i>Student</a>
                    </li>

                    <li>
                        <a style="color:#FFFFFF" href="admin"><i class="fa fa-sign-in fa-fw"></i>Admin</a>
                    </li>
                </ul>
            </div>
        </div>
