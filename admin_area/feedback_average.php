...
{
//Count total Votes
$r=mysqli_query($conn,"select * from feed where faculty_id='$faculty'");
$c=mysqli_num_rows($r);	
...
//question 1 start
error_reporting(1);
$q=mysqli_query($conn,"select * from feed where faculty_id='$faculty'");
...
//question 2 start
$q2=mysqli_query($conn,"select * from feed where faculty_id='$faculty'");
