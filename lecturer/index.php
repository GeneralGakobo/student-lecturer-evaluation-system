<?php
	...
	if(isset($login))
	{
$que=mysqli_query($conn,"select user_name and password from faculty where user_name='$email' and password='$pass'");
...
<head>
    ...
    <title>UEAB Lecturer Dashboard</title>
                    ...
                    <div class="panel-heading" style="background:#330066">
                     <image src="images/ueab_logo.png" class="logo" style=" margin-bottom:0px">
                      <a style="color:#FFFFFF;">EVALUATION SYSTEM</a>
                        ...
                        <h3 class="panel-title text-center" style="color:#ffffff">Faculty Sign In</h3>
                    </div>
                    <div class="panel-body" style="padding-top:40px;">
                        <form method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" name="email" type="text" autofocus required placeholder="User Name">
                                </div>
                                <div class="form-group">
