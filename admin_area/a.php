...
?>
<?php 
$q=mysqli_query($conn,"select * from feed where ref_id='".$res['ref_id']."' ");
...
while($row=mysqli_fetch_array($q))
{
    ...
    echo "<tr>";
            ...
            echo "<td>".$row['quest15']."</td>";
            echo "<td>".$row['quest16']."</td>";
            echo "<td>".$row['quest17']."</td>";
            echo "<td>".$row['quest18']."</td>";
            echo "<td>".$row['quest19']."</td>";
            echo "<td>".$row['quest20']."</td>";
            echo "<td>".$row['quest21']."</td>";
            echo "<td>".$row['quest22']."</td>";
            echo "<td>".$row['quest23']."</td>";
            echo "<td>".$row['quest24']."</td>";
            echo "<td>".$row['quest25']."</td>";
            echo "<td>".$row[36]."</td>";
