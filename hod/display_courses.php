...
<table class="table table-bordered">
	<tr>
		...
		<td colspan="8">
		<input type="text"  placeholder="Search Course by course id,course name" name="searchGroup" class="form-control" required />
		</td>
		<td colspan="8">
...
$query = "SELECT * FROM hod where user_name='$user'";
	...
	$i=1;
	$que=mysqli_query($conn,"select * from courses where department_offered='$yu' ORDER BY department_offered ASC");
