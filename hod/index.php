<?php
	...
	if(isset($login))
	{
$que=mysqli_query($conn,"select user_name and password from hod where user_name='$email' and password='$pass'");
                    ...
                    <div class="panel-heading" style="background:#330066">
                     <image src="images/ueab_logo.png" class="logo" style=" margin-bottom:0px">
                      <a style="color:#FFFFFF;">EVALUATION SYSTEM</a>
                        ...
                        <h3 class="panel-title text-center" style="color:#ffffff">HOD Sign In</h3>
                    </div>
