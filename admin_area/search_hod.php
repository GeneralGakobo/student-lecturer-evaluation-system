...
$q=mysqli_query($conn,"select * from hod where Name='$search' or 	email='$search' or school='$search' or department='$search' or mobile='$search' ");
...
<table class="table table-bordered">
	...
	<tr>
		<td colspan="16"><a href="dashboard.php?info=display_hod">Go Back to hod's Page</a></td>
	</tr>
	<Tr class="active">
		<th>Sr.No</th>
        <th>Name</th>
