...
<table class="table table-bordered">
	<tr>
		...
		<form method="post" action="dashboard.php?info=ref_results">
...
<?php
 ...
 $conn=mysqli_connect("localhost","root","","ueab")or die(mysqli_error());
	...
	echo "<td>".$row['offered_by']."</td>";	
	  ...
	  echo "<td class='text-center'><a href='dashboard.php?id=$row[id]&info=a'><button type='submit' class='btn btn-success'>GO</button></a></td>";
