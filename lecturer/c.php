...
$query = "select AVG(quest1) as avg from feed where id='".$_GET['id']."'";
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest2) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output1 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest3) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output2 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest4) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output3 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest5) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output4 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest6) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output5 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest7) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output6 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest8) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output7 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest9) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output8 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest10) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output9 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest11) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output10 = $row['avg'];
}
...
$conn = mysqli_connect("localhost","root","","ueab") or die("db error!");
$query = "select AVG(quest12) as avg from feed where id='".$_GET['id']."'";
$query_result = mysqli_query($conn, $query);
while($row=mysqli_fetch_assoc($query_result)){
$output11 = $row['avg'];
}
...
<table class="table table-bordered">
	...
	<?php
	$q2=mysqli_query($conn,"select * from user_selected_courses where id='".$_GET['id']."'");
	$r2=mysqli_num_rows($q2);			
	echo "<h4 style='color:black'>Total number of students acquinted : $r2</h4>"; 	
	?>
	
	<?php
	$q2=mysqli_query($conn,"select * from feed where id='".$_GET['id']."'");
	$r2=mysqli_num_rows($q2);			
